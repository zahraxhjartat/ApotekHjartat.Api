    ...
    public class OrderDbContextFactory : IDesignTimeDbContextFactory<OrderDbContext>
    {
        ...
        public OrderDbContextFactory()
        {
            ...
            Configuration = new ConfigurationBuilder()
                ...
                .AddJsonFile(Path.Combine($"{System.IO.Directory.GetCurrentDirectory()}", $"../ApotekHjartat.Api/appsettings{settingsEx}.json"), optional: false, reloadOnChange: true)
        ...
        public OrderDbContext CreateDbContext(string[] args)
        {
            ...
            builder.UseSqlServer(
                ...
                sqlServerOptionsAction: sqlOptions => sqlOptions.MigrationsAssembly("ApotekHjartat.DbAccess"));
